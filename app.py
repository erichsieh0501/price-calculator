...
if st.session_state.reset:
    ...
    st.session_state.reset = False  # 重設一次後就關閉 reset flag
else:
    ...
    profit_margin_input = st.number_input("💰 毛利率（%）：", min_value=0.0, max_value=100.0, format="%.2f", value=60.0)
